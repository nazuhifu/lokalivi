      ...
      <AppLayout>
        <div className="container mx-auto px-4 py-10 md:px-6 lg:px-20">
            <div className="mb-10 text-center">
                ...
                <p className="mt-4 text-muted-foreground">Crafting timeless furniture that blends traditional craftsmanship with modern design.</p>
            </div>
            ...
            <div className="grid gap-12">
                ...
                <section className="grid gap-8 lg:grid-cols-2 lg:gap-12">
                    <div className="relative h-[300px] overflow-hidden rounded-lg sm:h-[400px] lg:h-full">
                        <img src="/placeholder.svg?height=600&width=800" alt="Craftsman working on furniture" className="object-cover" />
                    </div>
                    <div className="flex flex-col justify-center space-y-4">
                        ...
                        <p className="text-muted-foreground">
                            Our name, LokaLivi, reflects our belief that furniture should bring warmth and comfort to your living spaces, just like
                            the sun (Sol) brings light and life to our world. We believe that a home filled with thoughtfully crafted pieces creates a
                            sanctuary where life's most precious moments unfold.
                        </p>
                    </div>
                </section>
                ...
                <section className="grid gap-8 lg:grid-cols-2 lg:gap-12">
                    <div className="order-2 flex flex-col justify-center space-y-4 lg:order-1">
                        ...
                        <p className="text-muted-foreground">
                            We source the finest hardwoods from responsibly managed forests, and our finishing processes use low-VOC, environmentally
                            friendly materials. Our commitment to quality means that every joint is precision-cut, every surface is meticulously
                            sanded, and every finish is carefully applied by hand.
                        </p>
                        <p className="text-muted-foreground">
                            The result is furniture that not only looks beautiful but is built to last for generations, becoming more beautiful with
                            age and use.
                        </p>
                    </div>
                    <div className="relative order-1 h-[300px] overflow-hidden rounded-lg sm:h-[400px] lg:order-2 lg:h-full">
                        <img src="/placeholder.svg?height=600&width=800" alt="Furniture craftsmanship details" className="object-cover" />
                    </div>
                </section>
                ...
                <section className="rounded-lg bg-[#f8f5f0] p-8 text-center">
                    ...
                    <p className="mt-4 text-muted-foreground">
                        Experience the quality and craftsmanship of LokaLivi furniture in person. Our showroom features our full collection and our
                        team is available to help you find the perfect pieces for your home.
                    </p>
